...
class SplitImage():
    def __init__(self, 
        ...
        self.pixel_anno_path = './data/{}/{}/{}/anno_v2'.format(core_dataset_name, src_version, imageset)
    ...
    def split_image(self, image_fn):
        ...
        pixel_anno_file = os.path.join(self.pixel_anno_path, image_fn.replace('jpg', 'png'))
...
if __name__ == '__main__':
    ...
    src_version = 'v0'
    dst_version = 'v1'
    imagesets = ['shanghai', 'chengdu', 'jinan', 'haerbin', 'beijing', 'xian']
