...
class Simpletxt2Json():
    ...
    def simpletxt2json(self, image_fn):
        ...
        roof_shp_file = './data/buildchange/{}/{}/{}/roof_shp_pixel/{}'.format(src_version, self.city, sub_fold, ori_image_fn + '.shp')
        geo_info_file = './data/buildchange/{}/{}/{}/images/{}'.format(src_version, self.city, sub_fold, ori_image_fn + '.jpg')
