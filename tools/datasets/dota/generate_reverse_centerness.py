...
class PseudomaskGenerate():
    def __init__(self,
        ...
        self.save_dir_names = {'centerness': 'reverse_centerness_seg',
        ...
        self.gaussian_image = 255 - generate_gaussian_image(512, 512, 2.5, threshold = int(self.heatmap_rate * 255))
        self.centerness_image = 255 - generate_centerness_image(512, 512, factor=self.factor, threshold = int(self.heatmap_rate * 255))
        self.ellipse_image = 255 - generate_ellipse_image(512, 512, threshold = int(self.heatmap_rate * 255))
