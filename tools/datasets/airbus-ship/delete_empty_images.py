...
dataset_train = './data/airbus-ship/v1/train/images'
csv_train = 	'./data/airbus-ship/v1/train/labels/train_ship_segmentations_v2.csv'
...
if __name__ == '__main__':
    ...
    for im in ims:
        if im not in images:
            print(os.path.join(dataset_train, im))
