...
class splitbase():
    def __init__(self,
        ...
        self.labelpath = os.path.join(self.basepath, 'labelTxt-{}'.format(self.dota_version))
        self.outimagepath = os.path.join(self.outpath, 'images')
        self.outlabelpath = os.path.join(self.outpath, 'labelTxt-{}'.format(self.dota_version))
...
if __name__ == '__main__':
    ...
    split = splitbase(src, dst, gap=200, subsize=1024, num_process=8, dota_version=dota_version)
