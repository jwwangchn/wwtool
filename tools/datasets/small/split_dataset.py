...
src_ann_file_name = ['small', 'trainval_test', 'v1', '1.0']
...
print("trainval: {}, train: {}, val: {}, test: {}".format(len(trainval_image_ids), len(train_image_ids), len(val_image_ids), len(test_image_ids)))
