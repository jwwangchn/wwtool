...
image_dir = '/home/jwwangchn/Documents/100-Work/170-Codes/aidet/data/buildchange/v2/xian_fine/images'
models = ['bc_v014_mask_rcnn_hrnetv2p_w32_v2_roof_trainval']
for model in models:
    print(model)
    ...
    for idx, imgId in enumerate(imgIds):
        ...
        for label in range(len(det)):
            ...
            for i in range(bboxes.shape[0]):
                ...
                transform_matrix = [1, 0, 0, 1, -10 * offset[0], -10 * offset[1]]
    ...
    csv_dataset.to_csv(f'/home/jwwangchn/Documents/100-Work/170-Codes/aidet/results/buildchange/{model}/result_roof.csv', index=False)