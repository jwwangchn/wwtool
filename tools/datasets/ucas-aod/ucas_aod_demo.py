...
if __name__ == '__main__':
    ...
    imgDir = './data/UCAS-AOD/{}/coco/{}/'.format(release_version, imageset)
    annFile='./data/UCAS-AOD/{}/coco/annotations/ucas_aod_{}_{}_{}_{}_{}.json'.format(release_version, imageset, release_version, rate, pointobb_sort_method, extra_info)
