...
if __name__ == '__main__':
    ...
    imgDir = './data/dior/{}/coco/{}/'.format(release_version, imageset)
    annFile='./data/dior/{}/coco/annotations/dior_{}_{}_{}_small_object.json'.format(release_version, imageset, release_version, rate)
