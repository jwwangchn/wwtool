...
__all__ = [
    "mergebypoly", "mergebyrec", "dota_eval_task1", "dota_eval_task2", "GetFileFromThisRootDir", "custombasename", "parse_dota_poly2", "split_with_gt", "split_without_gt", "parse_dota_poly"
]
